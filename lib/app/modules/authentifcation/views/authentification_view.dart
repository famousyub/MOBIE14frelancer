...
class AuthentifcationView extends GetView<AuthentifcationController> {
  const AuthentifcationView({Key? key}) : super(key: key);
  @override
                                  ...
                                  onPressed: () {
                                    ...
                                    if (controller.form.currentState!
                                        .validate()) {
                                          ...
                                          controller.save(context,controller.user);
