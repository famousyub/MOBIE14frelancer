...
class DossierView extends GetView<DossierController> {
  const DossierView({Key? key}) : super(key: key);
  @override
                        ...
                        children: [
                          ...
                          ListTile(
                            subtitle: Column(
                              ...
                              children: const [
                                Text('1109042-001'),
                                Text('2023-07-11   12:58'),
                                Text('NFS/CRE/CRP/ECBU GLY/URE'),
                              ],
                            ),
                          ),
                        ],
